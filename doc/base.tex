...
\label{sec-interject-copy-trans}\subsection{\tt{INTERJECT!COPY!TRANS}}
This tutorial was thoughtfully provided by Jason Compton.
...
\label{sec-interject-copy-trans2}\subsection{\tt{INTERJECT!COPY!TRANS2}}
...
\t{GET!OFFSET!ARRAY} performs "Iterations" number of reads and sets the array \verb+$string(0)+, \verb+$string(1)+ etc to the result of these reads. A more detailed explanation can be had in the \ahrefloc{sec-get-offset-array12}{\tt{GET!OFFSET!ARRAY} and \tt{GET!OFFSET!ARRAY2} tutorial}.\\
...
"Offset2" corresponds to the result from \ttref{GET!OFFSET!ARRAY}. "Offset" is read from the start of the file. "Iterations" and "Index" are read from Offset2 + value. Apart from that \t{GET!OFFSET!ARRAY2} functions like \ttref{GET!OFFSET!ARRAY}. A more detailed explanation can be had in the \ahrefloc{sec-get-offset-array12}{\tt{GET!OFFSET!ARRAY} and \tt{GET!OFFSET!ARRAY2} tutorial}.\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\label{sec-add-store-item}\subsection{\tt{ADD!STORE!ITEM} (Last Update: v211)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\t{SET!2DA!ENTRY!LATER} and \t{SET!2DA!ENTRIES!NOW} (Last Update: v241)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
tutorial for \t{SET!2DA!ENTRY} exists.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\label{sec-modder}\subsection{\tt{MODDER} (Last update: v230)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\label{sec-match-and-try}\subsection{\tt{MATCH} and \tt{TRY} (last edit: 245)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
