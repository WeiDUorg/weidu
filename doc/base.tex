...
to only have default actions, or to have a group of guarded actions without a
guard, as per the following examples:
\begin{verbatim}
...
WITH
  BEGIN
    DO_SOMETHING // unguarded guarded action: never executed
  END
  ~error~
  BEGIN
    FAIL ~error~
