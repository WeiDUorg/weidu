...
This function will delete all links from one specified area to another. Links will be deleted from all four directional nodes (north, east, south, west). Links connecting the areas in the opposite direction will not be deleted.
...
\item INT_VAR \verb+default_entry+ to the default entry location. Legal values for this variable are 1 (northern side), 2 (eastern), 3 (southern) and 4 (western). The default value is 1.
