...
\ttref{value} &
  ...
  future. The change is stored is stored in variables derived from the
...
undefined. In is specifically not safe to use the same string you use
for \t{READ!2DA!ENTRIES!NOW} as you are using for
\ttref{SET!2DA!ENTRIES!LATER}. In this example, the string follows the
