...
\end{verbatim}
  ...
  or & \DEFINE{ADD_JOURNAL} \Ob \t{EXISTING} \Oe \Ob \t{MANAGED} \Oe \Ob
    ...
    the game is of an EE-type, this action patches BGEE.LUA with the
    provided quests and journal entries, so they will work with the
    EE-type journal system.
    ...
    BGEE.LUA is patched with the strrefs of the title and journal entry.
