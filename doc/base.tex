...
chose to install one of the groups (or, of course, if he chose [A]). If the
user chose [S], [R] or [U] the same action will be applied to the components
in ALWAYS_ASK.

Caveats:
\begin{itemize}
\item If a component is in both ALWAYS_ASK and a group the mod will refuse to
install.
...
install) and will always be (re)installed (unless the user chooses [S]kip all).
