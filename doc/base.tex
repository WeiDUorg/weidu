...
\DEFINE{--dry-run} & Log file operations and shell commands without executing
them. This is intended for preview/audit runs and may not follow all runtime
branches exactly. For broader branch exploration, combine with
\ttref{--continue}. \\
