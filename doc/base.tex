...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\label{sec-modder}\subsection{\t{MODDER} (Last update: v230)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
This function supports Windows, OS\begin{rawhtml}&nbsp;\end{rawhtml}X and GNU/Linux. If the game is BG: EE or BGII: EE, \t{TRA} files are encoded into \t{UTF-8} so the text can be installed without causing problems. \verb+HANDLE_CHARSETS+ needs to be used before any text is installed and is compatible with \ttref{AUTO!TRA} and all other methods of loading \t{TRA} files, unless the option \verb+out_path+ is used.
