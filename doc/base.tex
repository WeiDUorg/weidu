...
\label{interject-copy-trans2}\subsection{\tt{INTERJECT!COPY!TRANS2}}
...
\DEFINE{Component Flag} &&
  ...
  or & \DEFINE{SUBCOMPONENT} \ttref{String} \Ob \ttref{value} \Oe &
      ...
      listed together for the user. See the \ahrefloc{sec-subomponent}{SUBCOMPONENT tutorial}. \\
...
\t{GET!OFFSET!ARRAY} performs "Iterations" number of reads and sets the array \verb+$string(0)+, \verb+$string(1)+ etc to the result of these reads. A more detailed explanation can be had in the \ahrefloc{sec-get-offset-array12}{\ttGET!OFFSET!ARRAY and \ttGET!OFFSET!ARRAY2 tutorial}.\\
