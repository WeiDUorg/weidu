...
\t{inv24}. ADD!CRE!EFFECT will add the item to the first empty slot in
...
will make the creature have the weapon selected. The optional
argument \t{TWOHANDED} also only applies to weapon slots and will cause
items in the shield slot to be unequipped.  See the
\ttref{ADD!CRE!ITEM} tutorial. \\
