...
This is a PATCH macro and function.
\begin{itemize}
\item SET type to the header type to copy the effect from (use 99 to speficy 'all types').
...
\item STR_VAR \verb+worlmap+ to the name of the .wmp file you want patched (default is "worldmap");
